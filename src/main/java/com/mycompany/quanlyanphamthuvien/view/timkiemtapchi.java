...
public class timkiemtapchi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form timkiemtapchi
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(timkiemtapchi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new timkiemtapchi().setVisible(true);
            }
        });
    }
